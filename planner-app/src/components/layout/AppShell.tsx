...
import { Calendar, CalendarDays, CalendarRange, LayoutDashboard, BarChart2, History } from 'lucide-react';
...
const BOTTOM_NAV: { view: ViewType; label: string; icon: React.ElementType }[] = [
